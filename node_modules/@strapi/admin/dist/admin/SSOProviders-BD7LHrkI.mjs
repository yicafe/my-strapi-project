...
const SSOProviders = ({ providers, displayAllProviders }) => {
  ...
  if (displayAllProviders) {
    return /* @__PURE__ */ jsx(Grid.Root, { gap: 4, children: providers.map((provider) => /* @__PURE__ */ jsx(Grid.Item, { col: 4, direction: "column", alignItems: "stretch", children: /* @__PURE__ */ jsx(SSOProviderButton, { provider }) }, provider.uid)) });
  }
  if (providers.length > 2 && !displayAllProviders) {
    return /* @__PURE__ */ jsxs(Grid.Root, { gap: 4, children: [
      providers.slice(0, 2).map((provider) => /* @__PURE__ */ jsx(Grid.Item, { col: 4, direction: "column", alignItems: "stretch", children: /* @__PURE__ */ jsx(SSOProviderButton, { provider }) }, provider.uid)),
...
//# sourceMappingURL=SSOProviders-BD7LHrkI.mjs.map
