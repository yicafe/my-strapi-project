...
import { UpdateMe } from '../../../shared/contracts/users';
declare const useCheckPermissionsQuery: import('@reduxjs/toolkit/dist/query/react/buildHooks').UseQuery<import('@reduxjs/toolkit/query').QueryDefinition<{
    ...
    token: string;
}, import('@reduxjs/toolkit/query').BaseQueryFn<string | import('../utils/baseQuery').QueryArguments, unknown, import('../utils/baseQuery').BaseQueryError>, "User" | "Me" | "ProvidersOptions", {
    token: string;
