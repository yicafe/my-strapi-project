...
declare const useCreateUserMutation: import('@reduxjs/toolkit/dist/query/react/buildHooks').UseMutation<import('@reduxjs/toolkit/query').MutationDefinition<import('../../../shared/contracts/shared').AdminUserCreationPayload, import('@reduxjs/toolkit/query').BaseQueryFn<string | import('../utils/baseQuery').QueryArguments, unknown, import('../utils/baseQuery').BaseQueryError>, "User" | "LicenseLimits" | "Role" | "RolePermissions", import('..').SanitizedAdminUser, "adminApi">>, useUpdateUserMutation: import('@reduxjs/toolkit/dist/query/react/buildHooks').UseMutation<import('@reduxjs/toolkit/query').MutationDefinition<Omit<Omit<import('..').AdminUser, keyof import('..').Entity | "roles"> & {
    ...
    role: Data.ID;
}, import('@reduxjs/toolkit/query').BaseQueryFn<string | import('../utils/baseQuery').QueryArguments, unknown, import('../utils/baseQuery').BaseQueryError>, "User" | "LicenseLimits" | "Role" | "RolePermissions", {
    ...
    id: Data.ID;
}, import('@reduxjs/toolkit/query').BaseQueryFn<string | import('../utils/baseQuery').QueryArguments, unknown, import('../utils/baseQuery').BaseQueryError>, "User" | "LicenseLimits" | "Role" | "RolePermissions", Roles.SanitizedPermission[], "adminApi">>;
