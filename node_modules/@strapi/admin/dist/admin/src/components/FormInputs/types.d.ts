...
interface StringProps extends Omit<InputProps, 'autoComplete' | 'type'>, Pick<ComponentPropsWithoutRef<'input'>, 'autoComplete'> {
...
interface InputProps {
    ...
    required?: boolean;
    options?: never;
    type: Exclude<Schema.Attribute.Kind, 'enumeration' | 'media' | 'blocks' | 'richtext' | 'dynamiczone' | 'component' | 'relation' | 'text' | 'string' | 'password' | 'email'> | 'checkbox';
}
