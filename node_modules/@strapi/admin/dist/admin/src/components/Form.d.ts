...
import { InputProps as InputPropsImpl, StringProps, EnumerationProps } from './FormInputs/types';
...
interface FormProps<TFormValues extends FormValues = FormValues> extends Partial<Pick<FormContextValue<TFormValues>, 'disabled' | 'initialValues'>> {
...
declare const useField: <TValue = any>(path: string) => FieldValue<TValue | undefined>;
/**
